...
my_model.classes = ['ao', 'banhkeo', 'bep', 'botgiat', 'ca', 'cathu', 'cahoi', 'caphe', 'carot', 'cha',
                    'chao', 'chuadung', 'congcu', 'dau', 'dep', 'dochoi', 'dodonghop', 'dogiadung', 'dohop',
                    'douong', 'dung', 'gao', 'gaolut', 'gaonep', 'giavi', 'giay', 'khoaitay', 'mi', 'migoi',
                    'mypham', 'noi', 'phukien', 'quan', 'rau', 'raucu', 'sach', 'sua', 'suabot', 'suatuoi',
                    'thit', 'thitbo', 'thitga', 'thit', 'traicay', 'traitao', 'trangsuc', 'trung', 'xabong',
